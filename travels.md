...
<div class="container">
  ...
  <div class="mySlides">
    ...
    <img src="/img/bates_campus.jpg" style="width:100%">
  </div>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor1" src="/img/columbia_campus.jpg" style="width:100%" onclick="currentSlide(1)" alt="First img">
    </div>
    <div class="column">
      <img class="demo cursor2" src="/img/bates_campus.jpg" style="width:100%" onclick="currentSlide(2)" alt="First img">
    </div>
  </div>
</div>
